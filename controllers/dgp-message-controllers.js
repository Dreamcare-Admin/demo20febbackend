...
const DGPMessage = require("../models/dgp-message");
...
const addMessageData = async (req, res, next) => {
  try {
    ...
    upload(req, res, async function (err) {
      ...
      const createdImage = new DGPMessage({
        name,
        name_in_marathi,
        post,
        post_in_marathi,
...
const updateMessageData = async (req, res, next) => {
  ...
  try {
    ...
    upload(req, res, async function (err) {
      ...
      let datatemp = await DGPMessage.findById(Id);
      ...
      datatemp.designation = designation;
...
const getMessageData = async (req, res, next) => {
  ...
  try {
    MessageData = await DGPMessage.find({ tag: tag });
